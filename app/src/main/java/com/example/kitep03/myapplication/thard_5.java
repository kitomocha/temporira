...
public class thard_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_hard5);
        ...
        ans1 = findViewById(R.id.img_na);//アニメーションと画像を結びつける
        ans2 = findViewById(R.id.img_tu);//アニメーションと画像を結びつける
        ans3 = findViewById(R.id.img_to);//アニメーションと画像を結びつける
        ans4 = findViewById(R.id.img_u);//アニメーションと画像を結びつける
        maru = findViewById(R.id.maru);//アニメーションと画像を結びつける
        batu = findViewById(R.id.batu);//アニメーションと画像を結びつける

        Sound_Tempo.setBGM_now(thard_5.this, R.raw.kyoku1, R.raw.rinngo_hig);
        ...
        Button_Click_Action_4_Tempo.Click(button, button2, button3, button4, button5, button6, button7
                ...
                , alpha1, alpha2, alpha3, alpha4, alpha5, alpha6, anseranime, thard_5.this, t_result.class, Sound_Tempo.p1, Sound_Tempo.p2);
