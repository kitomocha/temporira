...
public class tnomal_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_nomal4);
        ...
        ans3 = findViewById(R.id.img_bo);//アニメーションと画像を結びつける
        maru = findViewById(R.id.maru);//アニメーションと画像を結びつける
        batu = findViewById(R.id.batu);//アニメーションと画像を結びつける

        Sound_Tempo.setBGM_now(tnomal_4.this, R.raw.kyoku1, R.raw.rinngo_hig);
        ...
        Button_Click_Action_Tempo.Click(button, button2, button3, button4, button5, button6, button7,
                ...
                , alpha1, alpha2, alpha3, alpha4, alpha5, anseranime, tnomal_4.this, tnomal_5.class, Sound_Tempo.p1, Sound_Tempo.p2);
